// 16 unique projects from seed-additional.ts (excluding duplicates)
export const remainingProjects = [
  ...
  },
  {
    ...
    techStack: { frontend: ['React', 'TypeScript'], backend: ['Node.js', 'Express'], database: ['PostgreSQL'], tools: ['Stripe', 'Docker', 'JWT'] },
    architecture: 'React frontend, Express REST API, PostgreSQL database, JWT authentication, Stripe for payments',
    features: ['Tenant registration and login', 'Online rent payment system', 'Lease management', 'Maintenance request tracking', 'Owner dashboard', 'Financial reports generation', 'Automated rent reminders'],
    skillsRequired: ['REST API development', 'Authentication systems', 'Payment gateway integration', 'Relational database design', 'Role-based access control'],
    learningOutcomes: ['Build multi-role SaaS systems', 'Integrate payment APIs', 'Design financial workflows', 'Implement secure authentication', 'Deploy full-stack apps'],
    timeline: [
  ...
  },
  {
    ...
    techStack: { frontend: ['React'], backend: ['Python', 'FastAPI'], database: ['Elasticsearch'], tools: ['Kibana', 'Docker', 'Celery'] },
    architecture: 'FastAPI backend, Elasticsearch log indexing, Celery background jobs, React dashboard UI',
    features: ['Log ingestion pipeline', 'Real-time anomaly detection', 'Threat scoring system', 'Security alerts and notifications', 'Dashboard visualization', 'Incident history tracking'],
    skillsRequired: ['Python programming', 'Log analysis', 'Security fundamentals', 'Machine learning basics', 'Distributed systems'],
    learningOutcomes: ['Implement log pipelines', 'Build monitoring dashboards', 'Apply anomaly detection', 'Design scalable security systems'],
    timeline: [
  ...
  },
  {
    ...
    primaryTechnology: 'Next.js',
    techStack: { frontend: ['Next.js', 'TypeScript'], backend: ['Node.js'], database: ['PostgreSQL'], tools: ['Cloud Storage', 'JWT'] },
    architecture: 'Next.js full stack application with PostgreSQL database and role-based access control',
    features: ['Course creation', 'Video streaming', 'Quiz system', 'Assignment submission', 'Progress tracking', 'Certificate generation'],
    skillsRequired: ['Full-stack development', 'Authentication systems', 'File storage handling', 'Relational databases'],
    learningOutcomes: ['Build educational platforms', 'Handle multimedia content', 'Design scalable systems', 'Implement role-based systems'],
    timeline: [
  ...
  },
  {
    ...
    recommendedYear: 'Third Year',
    primaryTechnology: 'Python',
    techStack: { frontend: ['React'], backend: ['Python', 'FastAPI'], database: ['PostgreSQL'], tools: ['MQTT', 'Raspberry Pi', 'Docker'] },
    architecture: 'IoT sensors with MQTT communication, FastAPI backend, React dashboard',
    features: ['Slot detection', 'Real-time dashboard', 'Reservation system', 'Admin monitoring', 'Alert system'],
    skillsRequired: ['IoT fundamentals', 'Python backend', 'MQTT protocol', 'Database integration'],
    learningOutcomes: ['Build IoT systems', 'Handle real-time data', 'Design reservation systems', 'Deploy hardware-software integration'],
    timeline: [
  ...
  },
  {
    ...
    recommendedYear: 'Third Year',
    primaryTechnology: 'Python',
    techStack: { frontend: ['React'], backend: ['Python', 'FastAPI'], database: ['PostgreSQL'], tools: ['Pandas', 'Scikit-learn', 'Matplotlib'] },
    architecture: 'ML training pipeline, FastAPI prediction service, React dashboard visualization',
    features: ['Weather prediction model', 'Historical data analysis', 'Prediction dashboard', 'Graphical trend visualization', 'Model retraining system'],
    skillsRequired: ['Python programming', 'Data preprocessing', 'Regression models', 'API development'],
    learningOutcomes: ['Build time-series models', 'Deploy ML APIs', 'Visualize scientific data'],
    timeline: [
  ...
  },
  {
    ...
    recommendedYear: 'Final Year',
    primaryTechnology: 'Next.js',
    techStack: { frontend: ['Next.js', 'TypeScript'], backend: ['Node.js'], database: ['PostgreSQL'], tools: ['WebRTC', 'Socket.io', 'JWT'] },
    architecture: 'Next.js frontend, Node.js backend, WebRTC for video calls, PostgreSQL storage',
    features: ['Doctor-patient video consultation', 'Appointment booking system', 'Secure prescription sharing', 'Medical history records', 'Admin dashboard'],
    skillsRequired: ['WebRTC basics', 'Authentication systems', 'Database modeling', 'Real-time communication'],
    learningOutcomes: ['Build secure communication systems', 'Handle sensitive data', 'Implement real-time video apps'],
    timeline: [
  ...
  },
  {
    ...
    recommendedYear: 'Third Year',
    primaryTechnology: 'Next.js',
    techStack: { frontend: ['Next.js'], backend: ['Node.js'], database: ['PostgreSQL'], tools: ['Cloud Storage', 'JWT'] },
    architecture: 'Next.js full stack architecture with role-based access control',
    features: ['Job posting system', 'Resume upload', 'Application tracking', 'Employer dashboard', 'Search and filtering'],
    skillsRequired: ['Full-stack development', 'File uploads', 'Database relationships'],
    learningOutcomes: ['Build recruitment platforms', 'Implement search features', 'Design scalable systems'],
    timeline: [
  ...
  },
  {
    ...
    recommendedYear: 'Third Year',
    primaryTechnology: 'Node.js',
    techStack: { frontend: ['React'], backend: ['Node.js'], database: ['PostgreSQL'], tools: ['Socket.io'] },
    architecture: 'React frontend with Node.js backend and real-time updates via Socket.io',
    features: ['Kanban boards', 'Task assignment', 'Team chat', 'Deadline tracking', 'Progress analytics'],
    skillsRequired: ['Real-time communication', 'Database modeling', 'REST API development'],
    learningOutcomes: ['Build collaborative tools', 'Handle real-time updates', 'Design productivity systems'],
    timeline: [
  ...
  },
  {
    ...
    techStack: { frontend: ['React Native'], backend: ['Node.js'], database: ['MongoDB'], tools: ['Stripe', 'Firebase'] },
    architecture: 'React Native mobile frontend, Node.js backend, MongoDB storage',
    features: ['Restaurant listing', 'Order placement', 'Real-time delivery tracking', 'Payment integration', 'User reviews'],
    skillsRequired: ['Mobile development', 'API integration', 'Database modeling'],
    learningOutcomes: ['Build mobile commerce apps', 'Handle payment flows', 'Design scalable backend systems'],
    timeline: [
