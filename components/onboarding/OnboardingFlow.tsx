    ...
    return (
      <div className="w-full max-w-2xl mx-auto text-center">
        <div className="bg-glass-5 border border-border-10 rounded-lg p-12">
          <div className="mb-4">
            <div className="w-16 h-16 mx-auto bg-gradient-to-br from-purple-600 to-violet-600 rounded-full flex items-center justify-center shadow-lg shadow-purple-600/30">
